...
export const dict = {
  ...
  "session.review.git.commit": "Commit",
  "session.review.git.commitLoading": "Committing...",
  "session.review.git.commitSuccess": "Changes committed",
  "session.review.git.commitDialog.title": "Commit changes",
  "session.review.git.commitDialog.message": "Commit message",
  "session.review.git.commitDialog.placeholder": "Describe these changes",
  "session.review.git.commitDialog.action": "Commit",
  "session.review.git.commitDialog.actionLoading": "Committing...",
  "session.review.git.push": "Push",
  "session.review.git.pushLoading": "Pushing...",
  "session.review.git.pushSuccess": "Changes pushed",
  "session.review.git.fetch": "Fetch",
  "session.review.git.fetchLoading": "Fetching...",
  "session.review.git.fetchSuccess": "Remote fetched",
  "session.review.git.branch": "Branch",
  "session.review.git.branchLoading": "Switching branch...",
  "session.review.git.branchSuccess": "Branch switched",
  "session.review.git.branchDialog.title": "Switch branch",
  "session.review.git.branchDialog.name": "Branch name",
  "session.review.git.branchDialog.placeholder": "feature/my-branch",
  "session.review.git.branchDialog.create": "Create new branch",
  "session.review.git.branchDialog.action": "Switch",
  "session.review.git.branchDialog.actionLoading": "Switching...",
  "session.review.git.busy": "Another Git operation is already in progress",
